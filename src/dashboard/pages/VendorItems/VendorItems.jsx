...
//     if (
//       !withDrawPayload.vendor_id ||
//       !withDrawPayload.withdrawal_amount ||
...
//     const url =
//       "https://app.yallapadel.club/public/dashboard/withdrawWalletVendor";
...
//             <p>Remarks</p>
//           </div>
//           <div className="child button" onClick={(e) => handleSubmitUpload(e)}>
//             Send
//           </div>
...
//   const errorNotify = () => {
//     toast.error("Error Notification!", { position: "top-right" });
//   };
    ...
    <div className="vendor-items flex-row">
      <div className="user-data flex-col flex-5">
        ...
        <VendorNumbers
          ...
          oneC={"wallet balance"}
          twoN={numbers.available_balance}
          twoC={"available balance"}
          threeN={numbers.pending_balance}
          threeC={"pending balance"}
        />
        <AdsCard className="userBooking" />
        <TransTable
          url={`https://app.yallapadel.club/public/dashboard/getVendorWalletTransactions/${selectedUsers.id}`}
          title="Transactions"
        />
        {/* <TransTable url={`https://app.yallapadel.club/public/dashboard/getVendorWalletTransactions/16`}/> */}
        <VendorWithdrawTable
          url={`https://app.yallapadel.club/public/dashboard/getWithDrawsOfVendors/${selectedUsers.id}`}
          title="Withdraws"
        />
        {/* <VendorWithdrawTable url={`https://app.yallapadel.club/public/dashboard/getWithDrawsOfVendors/16`} title="Withdraws"/> */}
      </div>
